...
public class ScoreboardWebAdapter extends RecyclerView.Adapter<ScoreboardWebAdapter.ViewHolder>{
    private List<User> listData;

    public ScoreboardWebAdapter(List<User> listData) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.txtpoints.setText(String.valueOf(scoreboard.getWebScore()));
    }
