...
public class ScoreboardOOPAdapter extends RecyclerView.Adapter<ScoreboardOOPAdapter.ViewHolder>{
    private List<User> listData;

    public ScoreboardOOPAdapter(List<User> listData) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.txtpoints.setText(String.valueOf(scoreboard.getOopScore()));
    }
