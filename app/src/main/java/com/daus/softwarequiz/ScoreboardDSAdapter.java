...
public class ScoreboardDSAdapter extends RecyclerView.Adapter<ScoreboardDSAdapter.ViewHolder>{
    private List<User> listData;

    public ScoreboardDSAdapter(List<User> listData) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.txtpoints.setText(String.valueOf(scoreboard.getDataStrucScore()));
    }
